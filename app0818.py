...
# len(user_info.index)
# user_info.loc[len(user_info.index)] = ['jason', 'male', 'lxs', 'lala' ]
# user_info
...
def update_data(n_clicks,search_term_target,search_term_drug):
    ...
    return J_resultUQ_FULL.to_json('json_file/df_json.json', date_format='iso', orient='split'), J_Target_hold.to_json('json_file/df_t_json.json',date_format='iso', orient='split'), J_Drug_hold.to_json('json_file/df_d_json.json', date_format='iso', orient='split'), J_Target_pmid_UQ.to_json('json_file/df_t_pmid_json.json', date_format='iso', orient='split'), J_Drug_pmid_UQ.to_json('json_file/df_d_pmid_json.json', date_format='iso', orient='split')
#     print('=====t-json===================')
#     print(df_t_json)
#     print('=====d-json===================')
#     print(df_d_json)
    
#     return df_json, df_t_json, df_d_json, df_t_pmid_json, df_d_pmid_json
...
# search_term_target=""""proprotein convertase 9"[MeSH Terms] OR "proprotein convertase 9"[All Fields] OR "proprotein convertase subtilisin kexin type 9"[All Fields]"""
# search_term_drug=""""alirocumab"[Supplementary Concept] OR "alirocumab"[All Fields] OR "praluent"[All Fields] OR "alirocumab"[Supplementary Concept] OR "alirocumab"[All Fields] OR "alirocumab"[Supplementary Concept] OR "alirocumab"[All Fields]"""
...
# df_t_new = pd.read_json('df_t_json.json', orient='split')
# df_d_new = pd.read_json('df_d_json.json', orient='split')
# df_t_pmid_new = pd.read_json('df_t_pmid_json.json', orient='split')
# df_d_pmid_new = pd.read_json('df_d_pmid_json.json', orient='split')
...
@app.callback(Output('blocks', 'children'), [Input('store1', 'data'),Input('store2', 'data'),Input('store3', 'data'),Input('store4','data'),Input('store5', 'data')], prevent_initial_call=True)
def update_tab1_blocks(df_new, df_t_new, df_d_new, df_t_pmid_new, df_d_pmid_new ):
...
#     blocks = blocks(df_d_pmid, df_t_pmid, df_t, df_d, df),
    return blocks(df_d_pmid_new, df_t_pmid_new, df_t_new, df_d_new, df_new)
