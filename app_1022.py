...
#                             'margin-left':'10px',
                ...
                html.Div(id = 'block2',children=[html.P("NIH Funded PMID", style={'textAlign': 'center', 'fontWeight': 'bold', 'color': '#6A6567','padding': '1rem','font-size': '16px'},),
                        html.P(style={'color': '#823737'}, children=['Total: {:,}'.format(unique_pmid(prepare_data_block2_target(Target_hold, Drug_hold)) + unique_pmid(prepare_data_block2_drug(Target_hold, Drug_hold))), # target + drug
                                                                     html.Br(),
